...
df['Dia del hecho'] = df['Dia del hecho'].str.strip().str.capitalize()
...
app.layout = html.Div([
    html.H1("Mapa de Calor para Casos de Suicidio en Colombia entre 2016 y 2019", style={'color': '#FFFFE0'}),
